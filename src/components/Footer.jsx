          ...
          <div>
            ...
            <div className="flex gap-3 mb-4">
              {[
                ...
                { Icon: FaLinkedin, href: 'https://linkedin.com/in/shivamsharma-builds', color: 'hover:bg-blue-600' },
                { Icon: FaTwitter, href: 'https://x.com/ShivamSharjmt23', color: 'hover:bg-cyan-500' },
                { Icon: FaInstagram, href: 'https://www.instagram.com/shivamsharma_jmt', color: 'hover:bg-pink-600' },
